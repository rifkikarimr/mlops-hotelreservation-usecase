...
class DataIngestion:
    ...
    # Download csv file from GCP bucket to Raw Directories
    ...
    def split_data(self):
        try:
            logger.info("Starting the spilitting process")
